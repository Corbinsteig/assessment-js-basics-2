...
function canWeDeilver(zipCode) {
  ...
  let zipEvaluator = canWeDeilver(85205)
//   console.log(zipEvaluator)
...
let zipEvaluator2 = canWeDeilver(85205)
//   console.log(zipEvaluator2)
...
const newdeals=deals.map(deal => {
    if (deal.title === "15% Off!") {
        return {...deal, title: `10% Off!`};
    }
...
const newdeals2=newdeals.map(deal => {
    if (deal.desc === '   This deal lasts until the end of March! ') {
        return {...deal, desc: '   This deal lasts until the end of April! '};
    }
