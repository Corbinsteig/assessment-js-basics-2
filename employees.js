...
class Employee {
    constructor(employeeName, employeeShifts){
      this.name = employeeName;
      this.shift = employeeShifts;
    }
    getSchedule(){
...
const emp0ne = new Employee("corbin", "weekday mornings, weekday afternoons")

// console.log(emp0ne.getSchedule())
